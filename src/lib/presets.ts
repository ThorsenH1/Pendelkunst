...
export const presets: PresetConfig[] = [
  {
    ...
    settings: {
      ...
      paint: {
        ...
        baseThickness: 3.5, splashEnabled: true, splashIntensity: 0.7, opacity: 0.8, viscosity: 0.3, bucketCapacity: 60,
      },
  ...
  },
  {
    ...
    settings: {
      ...
      paint: {
        ...
        baseThickness: 4, splashEnabled: true, splashIntensity: 0.3, opacity: 0.75, viscosity: 0.6, bucketCapacity: 55,
      },
  ...
  },
  {
    ...
    settings: {
      ...
      paint: {
        ...
        baseThickness: 2.5, splashEnabled: false, splashIntensity: 0, opacity: 0.9, viscosity: 0.7, bucketCapacity: 40,
      },
  ...
  },
  {
    ...
    settings: {
      ...
      paint: {
        ...
        baseThickness: 3, splashEnabled: true, splashIntensity: 0.9, opacity: 0.7, viscosity: 0.2, bucketCapacity: 70,
      },
  ...
  },
  {
    ...
    settings: {
      ...
      paint: {
        ...
        baseThickness: 2, splashEnabled: false, splashIntensity: 0, opacity: 0.9, viscosity: 0.8, bucketCapacity: 35,
      },
  ...
  },
  {
    ...
    settings: {
      ...
      paint: {
        ...
        baseThickness: 2.5, splashEnabled: true, splashIntensity: 0.4, opacity: 0.85, viscosity: 0.4, bucketCapacity: 65,
      },
  ...
  },
  {
    ...
    settings: {
      ...
      paint: {
        ...
        baseThickness: 3, splashEnabled: false, splashIntensity: 0, opacity: 0.8, viscosity: 0.55, bucketCapacity: 45,
      },
  ...
  },
  {
    ...
    settings: {
      ...
      paint: {
        ...
        baseThickness: 2.5, splashEnabled: true, splashIntensity: 0.5, opacity: 0.75, viscosity: 0.35, bucketCapacity: 80,
      },
